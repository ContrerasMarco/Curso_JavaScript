...
Los verbos HTTP, también conocidos como métodos HTTP, son palabras clave estandarizadas que indican la acción 
que se desea realizar sobre un recurso en un servidor web. Estos verbos forman parte del protocolo HTTP, que 
define las reglas de comunicación entre un cliente (como un navegador web) y un servidor.

Los verbos HTTP más comunes son:

GET: Se utiliza para recuperar datos de un recurso específico. Es el método más utilizado y no modifica el 
estado del servidor.
...
PATCH: Se utiliza para actualizar un recurso existente de forma parcial, como al cambiar la dirección de 
